...
const messages = [
    ...
    "Muy segura??",
    "100% segura?",
    "Mi reina por favoooor...",
    "Piensalo un poquito :c",
    "Si dices que no me pondre triste...",
    "Pero muuuuy triste :c",
    "Ya deja de jugar con el no jajaja :c",
    "Ok, ya entendí dejare de preguntar...",
    "Bromeaba jajaja, Di que sii! ❤️"
];
